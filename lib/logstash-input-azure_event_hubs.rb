...
require_jar('com.google.code.gson', 'gson', '2.8.6')
require_jar('com.fasterxml.jackson.datatype', 'jackson-datatype-joda', '2.10.1')
require_jar('com.squareup.retrofit2', 'converter-jackson', '2.7.2')
require_jar('com.fasterxml.jackson.core', 'jackson-databind', '2.10.1')
require_jar('com.fasterxml.jackson.core', 'jackson-core', '2.10.1')
require_jar('com.microsoft.azure', 'azure-keyvault-core', '1.2.4')
require_jar('org.apache.commons', 'commons-lang3', '3.8.1')
...
require_jar('com.fasterxml.jackson.core', 'jackson-annotations', '2.10.1')
require_jar('joda-time', 'joda-time', '2.9.9')
require_jar('com.squareup.okio', 'okio', '1.17.2')
