...
Azure Event Hubs natively supports the https://learn.microsoft.com/en-us/azure/event-hubs/azure-event-hubs-kafka-overview[Apache Kafka protocol] on Standard, Premium, and Dedicated tiers.
